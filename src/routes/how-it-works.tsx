...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({ meta: [{ title: "How it works — Mukuba Suggestion Box" }, { name: "description", content: "Submit, track and resolve — the workflow behind the Mukuba suggestion platform." }] }),
  component: () => (
